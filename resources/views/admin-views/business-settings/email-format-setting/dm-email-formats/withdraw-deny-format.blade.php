    ...
    <div class="content container-fluid">
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active">
                <div class="card mb-3">
                    @php($mail_status=\App\Models\BusinessSetting::where('key','withdraw_deny_mail_status_dm')->first()?->value ?? '0')
                    ...
                    <div class="card-body">
                        ...
                        <span class="form-label-secondary text--primary" data-toggle="tooltip" data-placement="right" data-original-title="{{ translate('If_a_Delivery_man_requests_for_a_withdrawal_and_Admin_rejects_it,_the_Delivery_man_will_get_an_automated_Withdraw_Rejection_email_from_the_system.') }}">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                <input type="checkbox" class="status toggle-switch-input dynamic-checkbox"
                                       ...
                                       data-text-on="<p>{{translate('If_enabled,_Delivery_men_will_receive_an_automated_mail_from_the_system_when_the_Admin_Rejects_their_Withdraw_Request.')}}</p>"
                                       data-text-off="<p>{{translate('If_disabled,_Delivery_men_will_not_receive_any_Withdrawal_Rejection_mail.')}}</p>"
                        ...
                        <form action="{{route('admin.business-settings.email-status',['dm','withdraw-deny',$mail_status == '1'?0:1])}}" method="get" id="mail-status_form">
                        </form>
                    </div>
                </div>
                            ...
                            <div class="email-format-wrapper">
                                ...
                                <div class="right-content">
                                    <div class="d-flex flex-wrap justify-content-between __gap-15px mt-2 mb-5">
                                        @php($data=\App\Models\EmailTemplate::withoutGlobalScope('translate')->where('type','dm')->where('email_type', 'withdraw_deny')->first())
