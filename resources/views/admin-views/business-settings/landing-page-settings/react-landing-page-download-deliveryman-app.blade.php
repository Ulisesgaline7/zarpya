...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="card py-3 px-xxl-4 px-3 mb-20">
            <div class="d-flex flex-sm-nowrap flex-wrap gap-3 align-items-center justify-content-between">
                <div class="">
                    <h3 class="mb-1">{{ translate('Deliveryman App Download Section') }}</h3>
                    <p class="mb-0 gray-dark fs-12">
                        {{ translate('See how your Deliveryman App Download Section will look to customers.') }}
                    </p>
                </div>
                <div class="max-w-300px ml-sm-auto">
                    <button type="button" class="btn btn-outline-primary py-2 fs-12 px-3 offcanvas-trigger"
                            data-target="#deliveryMan-downloadApp_section">
        ...
        @php($download_dm_app_section_status = \App\Models\DataSetting::where('type', 'react_landing_page')->where('key', "download_dm_app_section_status")->first())
        <div class="card py-3 px-xxl-4 px-3 mb-15 mt-4">
            <div class="row g-3 align-items-center justify-content-between">
                <div class="col-xxl-9 col-lg-8 col-md-7 col-sm-6">
                    <div class="">
                        <h3 class="mb-1">{{ translate('Show Deliveryman App Download Section') }}</h3>
                        <p class="mb-0 gray-dark fs-12">
                ...
                <div class="col-xxl-3 col-lg-4 col-md-5 col-sm-6">
                    <div class="py-2 px-3 rounded d-flex justify-content-between border align-items-center w-300">
                        ...
                        <form
                            action="{{ route('admin.business-settings.statusUpdate', ['type' => 'react_landing_page', 'key' => 'download_dm_app_section_status']) }}"
                        ...
                        <label class="toggle-switch toggle-switch-sm" for="CheckboxStatus">
                            <input type="checkbox" data-id="CheckboxStatus" data-type="status"
                                ...
                                {{ $download_dm_app_section_status?->value ? 'checked' : '' }}>
        ...
        <div class="card mb-20">
            <form class="custom-validation" action="{{ route('admin.business-settings.react-landing-page-settings', 'download-dm-app-section') }}"
                ...
                <div class="card-body">
                    ...
                    @php($download_dm_app_title = \App\Models\DataSetting::withoutGlobalScope('translate')->where('type', 'react_landing_page')->where('key', 'download_dm_app_title')->first())
                    @php($download_dm_app_sub_title = \App\Models\DataSetting::withoutGlobalScope('translate')->where('type', 'react_landing_page')->where('key', 'download_dm_app_sub_title')->first())
                    @php($download_dm_app_button_title = \App\Models\DataSetting::withoutGlobalScope('translate')->where('type', 'react_landing_page')->where('key', 'download_dm_app_button_title')->first())
                    @php($download_dm_app_image = \App\Models\DataSetting::withoutGlobalScope('translate')->where('type', 'react_landing_page')->where('key', 'download_dm_app_image')->first())
                                ...
                                <div class="row g-3">
                                    @if ($language)
                                        <div class="col-md-12 lang_form default-form">
                                            <div class="row g-1">
                                                <div class="col-12">
                                                    <label for="download_dm_app_title"
                                                    ...
                                                    <input id="download_dm_app_title" type="text" maxlength="50"
                                                           name="download_dm_app_title[]"
                                                           value="{{ $download_dm_app_title?->getRawOriginal('value') ?? '' }}"
                                                           class="form-control"
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <textarea type="text" name="download_dm_app_sub_title[]"
                                                              maxlength="1000"
                                                              placeholder="{{translate('messages.short_description')}}"
                                                              class="form-control min-h-90px ckeditor">{{$download_dm_app_sub_title?->getRawOriginal('value')}}</textarea>
                                                </div>
                                                <div class="col-12">
                                                    <label for="download_dm_app_button_title"
                                                    ...
                                                    <input id="download_dm_app_button_title" type="text" maxlength="20"
                                                           name="download_dm_app_button_title[]"
                                                           value="{{ $download_dm_app_button_title?->getRawOriginal('value') ?? '' }}"
                                                           class="form-control"
                                        ...
                                        @foreach($language as $lang)
                                                <?php
                                                $download_dm_app_title_translate = [];
                                                $download_dm_app_sub_title_translate = [];
                                                $download_dm_app_button_title_translate = [];

                                                if (isset($download_dm_app_title->translations) && count($download_dm_app_title->translations)) {
                                                    foreach ($download_dm_app_title->translations as $t) {
                                                        if ($t->locale == $lang && $t->key == 'download_dm_app_title') {
                                                            $download_dm_app_title_translate[$lang]['value'] = $t->value;
                                                        }
                                                    }
                                                }

                                                if (isset($download_dm_app_sub_title->translations) && count($download_dm_app_sub_title->translations)) {
                                                    foreach ($download_dm_app_sub_title->translations as $t) {
                                                        if ($t->locale == $lang && $t->key == 'download_dm_app_sub_title') {
                                                            $download_dm_app_sub_title_translate[$lang]['value'] = $t->value;
                                                        }
                                                    }
                                                }

                                                if (isset($download_dm_app_button_title->translations) && count($download_dm_app_button_title->translations)) {
                                                    foreach ($download_dm_app_button_title->translations as $t) {
                                                        if ($t->locale == $lang && $t->key == 'download_dm_app_button_title') {
                                                            $download_dm_app_button_title_translate[$lang]['value'] = $t->value;
                                                        }
                                                    }
                                                }
                                                ?>
                                            <div class="col-md-12 d-none lang_form" id="{{$lang}}-form">
                                                <div class="row g-1">
                                                    <div class="col-12">
                                                        <label for="download_dm_app_title{{$lang}}"
                                                               class="form-label">{{translate('Title')}}
                                                        ...
                                                        <input id="download_dm_app_title{{$lang}}" type="text"
                                                               maxlength="100"
                                                               name="download_dm_app_title[]"
                                                               value="{{ $download_dm_app_title_translate[$lang]['value'] ?? '' }}"
                                                               class="form-control"
                                                               placeholder="{{translate('messages.title_here...')}}">
                                                        <span
                                                            class="text-right text-counting color-A7A7A7 d-block mt-1">0/100</span>
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <label for="download_dm_app_sub_title{{$lang}}"
                                                               class="input-label"
                                                               for="exampleFormControlInput1">{{ translate('messages.sub title') }}
                                                            ({{strtoupper($lang)}})<span class="form-label-secondary"
                                                                                         data-toggle="tooltip"
                                                    ...
                                                    <i class="tio-info color-A7A7A7"></i>
                                                        ...
                                                        <textarea id="download_dm_app_sub_title{{$lang}}" type="text"
                                                                  name="download_dm_app_sub_title[]"
                                                                  maxlength="1000"
                                                                  placeholder="{{translate('messages.short_description')}}"
                                                                  class="form-control min-h-90px ckeditor">{{ $download_dm_app_sub_title_translate[$lang]['value'] ?? '' }}</textarea>
                                                    </div>

                                                    <div class="col-12">
                                                        <label for="download_dm_app_button_title{{$lang}}"
                                                               class="form-label">{{translate('Button Name')}}
                                                            ({{strtoupper($lang)}})<span class="form-label-secondary"
                                                                                         data-toggle="tooltip"
                                                                                         data-placement="right"
                                                        ...
                                                        <input id="download_dm_app_button_title{{$lang}}" type="text"
                                                               maxlength="20"
                                                               name="download_dm_app_button_title[]"
                                                               value="{{ $download_dm_app_button_title_translate[$lang]['value'] ?? '' }}"
                                                               class="form-control"
                                    ...
                                    @else
                                        <div class="col-12">
                                            <div class="mb-2">
                                                ...
                                                <input id="download_dm_app_title" maxlength="100" type="text"
                                                       name="download_dm_app_title[]"
                                                       class="form-control"
                                                       placeholder="{{translate('messages.title_here...')}}">
                                                <span
                                            ...
                                            <div class="mb-4">
                                                <label for="download_dm_app_sub_title"
                                                       class="form-label">{{translate('Sub Title')}}</label>
                                                <textarea id="download_dm_app_sub_title" rows="2" type="text"
                                                          maxlength="200"
                                                          name="download_dm_app_sub_title[]" class="form-control"
                                            ...
                                            <div class="mb-4">
                                                <label for="download_dm_app_button_title"
                                                       class="form-label">{{translate('Sub Title')}}</label>
                                                <input id="download_dm_app_button_title" maxlength="20" type="text"
                                                       name="download_dm_app_button_title[]" class="form-control"
                                                       placeholder="{{translate('messages.Button Name')}}">
                                                <span
                                                    class="text-right text-counting color-A7A7A7 d-block mt-1">0/200</span>
                                            </div>
                                ...
                                <div class="text-center">
                                    ...
                                    <div class="mx-auto text-center error-wrapper">
                                        <div class="upload-file_custom ratio-1 h-100px">
                                            <input type="file" name="download_dm_app_image"
                                                   class="upload-file__input single_file_input"
                                                   accept=".webp, .jpg, .jpeg, .png, .gif" {{ $download_dm_app_image?->value ? '' : 'required' }}>
                                            <label class="upload-file__wrapper w-100 h-100 m-0">
                                                ...
                                                <img class="upload-file-img" loading="lazy" src="{{ $download_dm_app_image?->value
    ...
    : '' }}" data-default-src="{{ $download_dm_app_image?->value
    ? \App\CentralLogics\Helpers::get_full_url('download_dm_app_section', $download_dm_app_image->value, $download_dm_app_image->storage[0]?->value ?? 'public', 'aspect_1')
    : '' }}" alt=""
                                                     style="{{ $download_dm_app_image?->value ? 'display: block;' : 'display: none;' }}">
                                            </label>
                                            <div class="overlay"
                                                 style="{{ $download_dm_app_image?->value ? 'display: block;' : 'display: none;' }}">
                                                <div
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active">
                @php($download_dm_app_main_button_title = \App\Models\DataSetting::withoutGlobalScope('translate')->where('type', 'react_landing_page')->where('key', 'download_dm_app_main_button_title')->first())
                @php($download_dm_app_main_button_sub_title = \App\Models\DataSetting::withoutGlobalScope('translate')->where('type', 'react_landing_page')->where('key', 'download_dm_app_main_button_sub_title')->first())
                                    ...
                                    <div class="col-12">
                                        @if ($language)
                                            <div class="col-md-12 lang_form default-form">
                                                <div class="row g-1">
                                                    <div class="col-12">
                                                        <label for="download_dm_app_main_button_title"
                                                               class="form-label">{{translate('Title')}}
                                                            ({{ translate('messages.default') }})
                                                            <span class="form-label-secondary" data-toggle="tooltip"
                                                                  data-placement="right"
                                                    ...
                                                    <i class="tio-info color-A7A7A7"></i>
                                                        ...
                                                        <input id="download_dm_app_main_button_title" type="text"
                                                               maxlength="100"
                                                               name="download_dm_app_main_button_title[]"
                                                               value="{{ $download_dm_app_main_button_title?->getRawOriginal('value')??'' }}"
                                                               class="form-control"
                                                               placeholder="{{translate('messages.title_here...')}}">
                                                        <span
                                                            class="text-right text-counting color-A7A7A7 d-block mt-1">0/100</span>
                                                    ...
                                                    <div class="col-12">
                                                        <label for="download_dm_app_main_button_sub_title"
                                                    ...
                                                    <i class="tio-info color-A7A7A7"></i>
                                                        ...
                                                        <input id="$download_dm_app_main_button_sub_title" type="text"
                                                               maxlength="200"
                                                               name="download_dm_app_main_button_sub_title[]"
                                                               value="{{ $download_dm_app_main_button_sub_title?->getRawOriginal('value')??'' }}"
                                                               class="form-control"
                                            ...
                                            @foreach($language as $lang)
                                                    <?php
                                                    if (isset($download_dm_app_main_button_title->translations) && count($download_dm_app_main_button_title->translations)) {
                                                        $download_dm_app_main_button_title_translate = [];
                                                        foreach ($download_dm_app_main_button_title->translations as $t) {
                                                            if ($t->locale == $lang && $t->key == 'download_dm_app_main_button_title') {
                                                                $download_dm_app_main_button_title_translate[$lang]['value'] = $t->value;
                                                            }
                                                        }

                                                    }
                                                    if (isset($download_dm_app_main_button_sub_title->translations) && count($download_dm_app_main_button_sub_title->translations)) {
                                                        $download_dm_app_main_button_sub_title_translate = [];
                                                        foreach ($download_dm_app_main_button_sub_title->translations as $t) {
                                                            if ($t->locale == $lang && $t->key == 'download_dm_app_main_button_sub_title') {
                                                                $download_dm_app_main_button_sub_title_translate[$lang]['value'] = $t->value;
                                                            }
                                                        }
                                                ...
                                                <div class="col-md-12 d-none lang_form" id="{{$lang}}-form1">
                                                    <div class="row g-1">
                                                        <div class="col-12">
                                                            <label for="download_dm_app_main_button_title{{$lang}}"
                                                                   class="form-label">{{translate('Title')}}
                                                    ...
                                                    <i class="tio-info color-A7A7A7"></i>
                                                            ...
                                                            <input id="download_dm_app_main_button_title{{$lang}}"
                                                                   type="text" maxlength="100"
                                                                   name="download_dm_app_main_button_title[]"
                                                                   value="{{ $download_dm_app_main_button_title_translate[$lang]['value']??'' }}"
                                                                   class="form-control"
                                                                   placeholder="{{translate('messages.title_here...')}}">
                                                            <span
                                                                class="text-right text-counting color-A7A7A7 d-block mt-1">0/100</span>
                                                        ...
                                                        <div class="col-12">
                                                            <label for="download_dm_app_main_button_sub_title{{$lang}}"
                                                                   class="form-label">{{translate('Sub Title')}}
                                                                ({{strtoupper($lang)}})<span
                                                                    class="form-label-secondary" data-toggle="tooltip"
                                                                    data-placement="right"
                                                    ...
                                                    <i class="tio-info color-A7A7A7"></i>
                                                            ...
                                                            <input type="text"
                                                                   id="download_dm_app_main_button_sub_title{{$lang}}"
                                                                   maxlength="200"
                                                                   name="download_dm_app_main_button_sub_title[]"
                                                                   value="{{ $download_dm_app_main_button_sub_title_translate[$lang]['value']??'' }}"
                                                                   class="form-control"
                                                                   placeholder="{{translate('messages.sub_title_here...')}}">
                                                            <span
                                                                class="text-right text-counting color-A7A7A7 d-block mt-1">0/200</span>
                                            ...
                                            <div class="col-md-12">
                                                <div class="row g-1">
                                                    <div class="col-12">
                                                        <label for="download_dm_app_main_button_title"
                                                               class="form-label">{{translate('Title')}}</label>
                                                        <input type="text" id="download_dm_app_main_button_title"
                                                               name="download_dm_app_main_button_title[]"
                                                               class="form-control"
                                                               placeholder="{{translate('messages.title_here...')}}">
                                                    </div>
                                            ...
                                            <div
                                                ...
                                                <label class="toggle-switch toggle-switch-sm m-0">
                                                    <input type="checkbox" name="dm_playstore_url_status"
                                                           ...
                                                           value="1" {{(isset($download_dm_app_links_data['playstore_url_status']) && $download_dm_app_links_data['playstore_url_status'])?'checked':''}}>
                                            ...
                                            <div
                                                ...
                                                <label class="toggle-switch toggle-switch-sm m-0">
                                                    <input type="checkbox" name="dm_apple_store_url_status"
                                                           ...
                                                           class="status toggle-switch-input dynamic-checkbox-toggle"
                                                           id="apple-dm-status"
                                                           value="1" {{(isset($download_dm_app_links_data['apple_store_url_status']) && $download_dm_app_links_data['apple_store_url_status'])?'checked':''}}>
                                                    <span class="toggle-switch-label text mb-0">
                                                    <span class="toggle-switch-indicator"></span>
                                                </span>
                                                </label>
    ...
    <div id="deliveryMan-downloadApp_section"
        ...
        <form action="{{ route('taxvat.store') }}" method="post">
            <div>
                <div
                    ...
                    <div class="py-1">
                        <h3 class="mb-0 line--limit-1">{{ translate('messages.Deliveryman App Download Section Preview') }}</h3>
                    </div>
                    <button type="button"
    ...
    :asset('assets/admin/img/400x400/deliveryman-dirver.png') }}"
                                ...
                                <div class="mt-xl-0 mt-2 max-w-353px">
                                    <h2 class="mb-xxl-2 mb-1 fs-24">
                                        {!! \App\CentralLogics\Helpers::highlightWords($download_dm_app_title?->value ?? 'Deliver More. $Earn$ More.') !!}
                                    </h2>
                                    @if($download_dm_app_sub_title?->value)
                                        <p class="text-title fs-12 mb-xxl-4 mb-xl-3 mb-3">
                                            {!!nl2br($download_dm_app_sub_title?->value)!!}
                                        </p>
                                    @else
                                        <p class="text-title fs-12 mb-xxl-4 mb-xl-3 mb-3">
                            ...
                            <div>
                                <div class="bg-white py-3 px-sm-5 px-1 rounded-10">
                                    <div class="mb-20 text-center">
                                        <h3 class="mb-1">{{ $download_dm_app_main_button_title?->value ?? 'Download the Driver App' }}</h3>
                                        <p class="mb-0 fs-12">{{ $download_dm_app_main_button_sub_title?->value ?? 'Take control of your rides anywhere.' }}</p>
                                    </div>
...
@push('script_2')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            var fileInput = document.querySelector('input[name="download_dm_app_image"]');
