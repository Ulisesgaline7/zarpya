...
@section('content')
    <div class="content container-fluid">
        ...
        @php($faq_section_status = \App\Models\DataSetting::where('type', 'react_landing_page')->where('key', "faq_section_status")->first())
                                    ...
                                    <div class="row g-3">
                                        @if ($language)
                                            ...
                                            @foreach(json_decode($language) as $lang)
                                                    ...
                                                    if (isset($faq_title->translations) && count($faq_title->translations)) {
                                                        foreach ($faq_title->translations as $t) {
                                                            if ($t->locale == $lang && $t->key == 'faq_title') {
                                                                $faq_title_translate[$lang]['value'] = $t->value;
                                                            }
                                                        }
                                                    }
                                                    ?>
                                                <div class="col-md-12 d-none lang_form" id="{{$lang}}-form">
                                                    <div class="row g-1">
                                                        <div class="col-12">
                                                            ...
                                                            <input id="faq_title{{$lang}}" type="text"
                                                                   maxlength="100"
                                                                   name="faq_title[]"
                    ...
                    <div class="card-body p-xxl-4 p-3">
                        ...
                        <i class="tio-info color-A7A7A7"></i>
                            ...
                            <i class="tio-info color-A7A7A7"></i>
                                                                ...
                                                                <input id="question{{$lang}}" type="text"
                                                                       maxlength="150"
                                                                       name="question[]"
                                                                       value=""
                                                                       class="form-control"
                                ...
                                @forelse ($faqs as $key => $faq)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <form
                                                action="{{ route('admin.business-settings.reactfaqStatus', [$faq->id, $faq->status ? 0 : 1]) }}"
                                        ...
                                        <td>
                                            <div class="btn--container justify-content-center">
                                                ...
                                                <form
                                                    action="{{ route('admin.business-settings.reactfaqDestroy',[$faq['id']]) }}"
                        ...
                        <div class="common-section-inner0">
                            ...
                            <ul class="nav nav-tabs rounded-10 border-0 question-tabs max-w-595 mx-auto mb-20"
                                ...
                                <li class="nav-item w-100" role="presentation">
                                    <button
                                        class="nav-link text-nowrap text-xl-start text-center d-xl-flex flex-xl-nowrap flex-wrap align-items-center gap-2 active"
                                        id="home-tab" data-toggle="tab" data-target="#home" type="button" role="tab"
                                        aria-controls="home" aria-selected="true">
                                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                             xmlns="http://www.w3.org/2000/svg">
                                            <g clip-path="url(#clip0_12693_439)">
                                                <path
                                                    d="M17.1126 10.6758H15.5659C15.7236 11.1074 15.8097 11.5732 15.8097 12.0588V17.9045C15.8097 18.1069 15.7745 18.3012 15.7104 18.4819H18.2674C19.2226 18.4819 19.9997 17.7048 19.9997 16.7496V13.5629C19.9998 11.9709 18.7046 10.6758 17.1126 10.6758Z"
                                                    fill="#222324" fill-opacity="0.4"/>
                                                <path
                                                    d="M4.19005 12.0588C4.19005 11.5732 4.27618 11.1074 4.43384 10.6758H2.88712C1.29516 10.6758 0 11.9709 0 13.5629V16.7497C0 17.7048 0.777072 18.4819 1.73227 18.4819H4.28938C4.22528 18.3011 4.19005 18.1069 4.19005 17.9045V12.0588Z"
                                                    fill="#222324" fill-opacity="0.4"/>
                                                <path
                                                    d="M11.7688 9.17188H8.23282C6.64086 9.17188 5.3457 10.467 5.3457 12.059V17.9047C5.3457 18.2236 5.60422 18.4821 5.92313 18.4821H14.0785C14.3974 18.4821 14.656 18.2236 14.656 17.9047V12.059C14.656 10.467 13.3608 9.17188 11.7688 9.17188Z"
                                                    fill="#222324" fill-opacity="0.4"/>
                                                <path
                                                    d="M9.99946 1.51562C8.08493 1.51562 6.52734 3.07321 6.52734 4.98778C6.52734 6.28642 7.2441 7.4206 8.30262 8.01607C8.80469 8.29849 9.38352 8.4599 9.99946 8.4599C10.6154 8.4599 11.1942 8.29849 11.6963 8.01607C12.7549 7.4206 13.4716 6.28638 13.4716 4.98778C13.4716 3.07325 11.914 1.51562 9.99946 1.51562Z"
                                                    fill="#222324" fill-opacity="0.4"/>
                                                <path
                                                    d="M3.90332 4.75391C2.47149 4.75391 1.30664 5.91875 1.30664 7.35059C1.30664 8.78243 2.47149 9.94728 3.90332 9.94728C4.26653 9.94728 4.61239 9.87204 4.92657 9.73681C5.46977 9.50294 5.91766 9.08895 6.19481 8.5704C6.38935 8.20645 6.50001 7.79126 6.50001 7.35059C6.50001 5.91879 5.33516 4.75391 3.90332 4.75391Z"
                                                    fill="#222324" fill-opacity="0.4"/>
                                                <path
                                                    d="M16.0967 4.75391C14.6648 4.75391 13.5 5.91875 13.5 7.35059C13.5 7.79129 13.6107 8.20649 13.8052 8.5704C14.0823 9.08899 14.5302 9.50298 15.0734 9.73681C15.3876 9.87204 15.7335 9.94728 16.0967 9.94728C17.5285 9.94728 18.6934 8.78243 18.6934 7.35059C18.6934 5.91875 17.5285 4.75391 16.0967 4.75391Z"
                                                    fill="#222324" fill-opacity="0.4"/>
                                            </g>
                                            <defs>
                                ...
                                <li class="nav-item w-100" role="presentation">
                                    <button
                                        class="nav-link text-nowrap text-xl-start text-center d-xl-flex flex-xl-nowrap flex-wrap align-items-center gap-2"
                                        id="contact-tab" data-toggle="tab" data-target="#contact" type="button"
                                        role="tab"
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="home" role="tabpanel"
                                    ...
                                    <div class="accordion d-flex flex-column gap-3 question-accordion"
                                         id="faqAccordion">
                                        @if(!empty($customerTab))
                                            @foreach($customerTab as $key => $customerFaq)
                                                    <?php
                                                ...
                                                <div class="card {{ $key == 4 ? 'disabled' : '' }}">
                                                    <div class="card-header-cus" id="{{ $headingId }}">
                                                        <button class="btn btn-link text-wrap text-title {{ $isActive ? '' : 'collapsed' }}"
                                                                type="button"
                                        ...
                                        @else
                                            <div class="card">
                                                <div class="card-header-cus" id="headingOne01">
                                                    <button class="btn btn-link text-wrap text-title" type="button"
                                                            data-toggle="collapse" data-target="#collapseOne01"
                                                            aria-expanded="true"
                                                ...
                                                <div id="collapseOne01" class="collapse show" aria-labelledby="headingOne01"
                                            ...
                                            <div class="card">
                                                <div class="card-header-cus" id="headingTwo02">
                                                    <button class="btn btn-link text-wrap text-title collapsed"
                                                            type="button"
                                                            data-toggle="collapse" data-target="#collapseTwo02"
                                                            aria-expanded="false" aria-controls="collapseTwo02">
                                                        What payment methods can I use, and are they secure?
                                                    </button>
                                                </div>
                                                <div id="collapseTwo02" class="collapse" aria-labelledby="headingTwo02"
                                                     data-parent="#faqAccordion2">
                                                    <div class="card-body max-w-700 pt-0">
                                                        To place an order, open the 6amMart app or website, browse or search
                                                        for
                                                        the products you need, and add them to your cart. At checkout, enter
                                                        your delivery address and payment details, then confirm your order
                                                        to
                                            ...
                                            <div class="card">
                                                <div class="card-header-cus" id="headingThree03">
                                                    <button class="btn btn-link text-wrap text-title collapsed"
                                                            type="button"
                                                            data-toggle="collapse" data-target="#collapseThree03"
                                                            aria-expanded="false" aria-controls="collapseThree03">
                                                        Can I schedule my delivery for a specific date and time?
                                                    </button>
                                                </div>
                                                <div id="collapseThree03" class="collapse" aria-labelledby="headingThree03"
                                                     data-parent="#faqAccordion2">
                                                    <div class="card-body max-w-700 pt-0">
                                                        To place an order, open the 6amMart app or website, browse or search
                                                        for
                                            ...
                                            <div class="card">
                                                <div class="card-header-cus" id="headingFour04">
                                                    <button class="btn btn-link text-wrap text-title collapsed"
                                                            type="button"
                                                            data-toggle="collapse" data-target="#collapseFour04"
                                                            aria-expanded="false" aria-controls="collapseFour04">
                                                        How can I track my order after placing it?
                                                    </button>
                                                </div>
                                                <div id="collapseFour04" class="collapse" aria-labelledby="headingFour04"
                                                     data-parent="#faqAccordion2">
                                                    <div class="card-body max-w-700 pt-0">
                                                        To place an order, open the 6amMart app or website, browse or search
                                                        for
                                            ...
                                            <div class="card disabled">
                                                <div class="card-header-cus" id="headingFive05">
                                                    <button class="btn btn-link text-wrap text-title collapsed"
                                                            type="button"
                                                            data-toggle="collapse" data-target="#collapseFive05"
                                                            aria-expanded="false" aria-controls="collapseFive05">
                                                        What is the return and refund policy for my orders?
                                                    </button>
                                                </div>
                                                <div id="collapseFive05" class="collapse" aria-labelledby="headingFive05"
                                                     data-parent="#faqAccordion2">
                                                    <div class="card-body max-w-700 pt-0">
                                                        To place an order, open the 6amMart app or website, browse or search
                                                        for
                                ...
                                <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                    <div class="accordion d-flex flex-column gap-3 question-accordion"
                                         id="faqAccordion2">
                                        @if(!empty($sellerTab))
                                            @foreach($sellerTab as $key => $sellerFaq)
                                                    <?php
                                                    $headingId = 'heading' . $key;
                                                    $collapseId = 'collapse' . $key;
                                                    $isActive = $key == 0;
                                ...
                                <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                                    <div class="accordion d-flex flex-column gap-3 question-accordion"
                                         id="faqAccordion3">
                                        @if(!empty($riderTab))
                                            @foreach($riderTab as $key => $riderFaq)
                                                    <?php
                                                    $headingId = 'heading' . $key;
                                                    $collapseId = 'collapse' . $key;
                                                    $isActive = $key == 0;
