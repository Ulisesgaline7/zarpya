...
@section('title',translate('messages.Add Surge Price'))
            ...
            <div class="card-body">
                ...
                <div class="lang_form" id="default-form">
                    <div class="form-group">
                        ...
                        <input autocomplete="off" type="text" name="surge_price_name[]" placeholder="Type surge price name" class="form-control">
                    </div>
                    <div class="form-group mb-0">
                        <div class="d-flex align-items-center gap-1 flex-wrap justify-content-between mb-2">
                            ...
                            <label class="toggle-switch toggle-switch-sm" for="customerDefault">
                                <input autocomplete="off" type="checkbox" name="customer_note_status" class="toggle-switch-input" id="customerDefault" value="1" checked>
                                <span class="toggle-switch-label">
                                    <span class="toggle-switch-indicator"></span>
                                </span>
                            </label>
                        </div>
                        <input autocomplete="off" type="text" name="customer_note[]" placeholder="Type note for customer" class="form-control">
                        ...
                        <div>
                            ...
                            <select name="module_ids[]" id="module_selected" class="form-control h--45px js-select2-custom" multiple="multiple" placeholder="Module Select" data-placeholder="Module">
                                ...
                                @foreach($modules as $module)
                                    <option value="{{ $module->id }}">{{ translate($module->module_name) }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                ...
                <div class="form-group w-100 mb-20">
                    ...
                    <div class="resturant-type-group shedule-checkbox-inner flex-md-nowrap border">
                        <label class="form-check w-100 form--check mr-2 mr-md-4">
                            <input autocomplete="off" class="form-check-input" type="radio" value="daily" name="duration_type" checked>
                            <span class="form-check-label">{{ translate('Daily Schedule') }}</span>
                        </label>
                        <label class="form-check w-100 form--check mr-2 mr-md-4">
                            <input autocomplete="off" class="form-check-input" type="radio" value="weekly" name="duration_type">
                            <span class="form-check-label">{{ translate('Weekly Schedule') }}</span>
                        </label>
                        <label class="form-check w-100 form--check mr-2 mr-md-4">
                            <input autocomplete="off" class="form-check-input" type="radio" value="custom" name="duration_type">
                                    ...
                                    <div class="bg-white p-sm-3 d-flex flex-column gap-3">
                                        <div>
                                            ...
                                            <div class="position-relative date-range__custom">
                                                ...
                                                <input autocomplete="off" type="text" class="form-control h-45 position-relative bg-transparent no-type"  name="daily_date_range" placeholder="{{ translate('messages.Select_Date') }}">
                                            </div>
                                        </div>
                                        <div class="time-range-wrapper">
                                            ...
                                            <div class="position-relative cursor-pointer">
                                                <i class="tio-time icon-absolute-on-right"></i>
                                                 <input autocomplete="off" type="text" class="form-control h-45 position-relative bg-transparent time-range-picker no-type" name="daily_time_range" placeholder="{{ translate('messages.Select_Time') }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                 ...
                                 <div class="shedule_item">
                                     <div class="bg-white p-sm-3 d-flex flex-column gap-3">
                                         <div class="cursor-pointer" data-toggle="modal" data-target="#weeklySelectDays_btn">
                                             ...
                                             <div class="position-relative date-range__custom">
                                                 ...
                                                 <input autocomplete="off" type="text" class="form-control h-45 position-relative bg-transparent date-range-input-demo no-type"
                                                     name="weekly_date_range" placeholder="{{ translate('messages.Select_Date') }}">
                                             </div>
                                         </div>
                                         ...
                                         <div class="time-range-wrapper">
                                             ...
                                             <div class="position-relative cursor-pointer">
                                                 <i class="tio-time icon-absolute-on-right"></i>
                                                  <input autocomplete="off" type="text" class="form-control h-45 position-relative bg-transparent time-range-picker no-type" name="weekly_time_range" placeholder="{{ translate('messages.Select_Time') }}">
                                             </div>
                                         </div>
                                         <input autocomplete="off" type="hidden" name="weekly_days" id="weekly_days" value="">
                                         <input autocomplete="off" type="hidden" name="is_permanent" id="is_permanent" value="">
                                     </div>
                                 </div>
                                <!-- Custom Schedule -->
                                 <div class="shedule_item">
                                     <div class="bg-white p-sm-3 d-flex flex-column gap-3">
                                         <div class="cursor-pointer" data-toggle="modal" data-target="#surgeCustom_sheduleBtn">
                                             ...
                                             <div class="position-relative">
                                                 <i class="tio-calendar-month icon-absolute-on-right"></i>
                                                 <input autocomplete="off" type="text" id="custom_schedule_input" class="form-control h-45 position-relative bg-transparent no-type" name="" placeholder="{{ translate('messages.Select Date & Time') }}">
                                             </div>
                                         </div>
                                         <input autocomplete="off" type="hidden" name="custom_days" id="custom_days" value="">
                                         <input autocomplete="off" type="hidden" name="custom_times" id="custom_times" value="">
      ...
      <div class="modal-body">
        <div class="modal-body-inner">
            <div class="resturant-type-group bg-light rounded p-3 mb-3 gap-4">
                ...
                <label class="form-check form--check mr-2 mr-md-4">
                    <input autocomplete="off" class="form-check-input rounded" type="checkbox" value="0" name="days">
            ...
            <div class="bg-light rounded p-3">
                ...
                <div class="mb-20">
                    ...
                    <div class="position-relative date-range__custom">
                        <i class="tio-calendar-month icon-absolute-on-right"></i>
                        <input autocomplete="off" type="text" class="form-control h-45 position-relative no-type" id="weekly_modal_date"  name="dates" placeholder="{{ translate('messages.Select_Date') }}">
                    </div>
                </div>
                <label class="form-check form--check mr-2 mr-md-4">
                    <input autocomplete="off" class="form-check-input rounded" type="checkbox" value="1" name="assign" id="weekly_is_permanent">
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        if (res.status) {
                            ...
                            setTimeout(() => {
                                window.location.href = "{{ route('admin.business-settings.zone.surge-price.list', [$zone['id']]) }}";
                            }, 1500);
                        }
                    },
                    error: function (xhr) {
