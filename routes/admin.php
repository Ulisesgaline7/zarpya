...
Route::group(['namespace' => 'Admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin', 'current-module', 'actch:admin_panel']], function () {
        ...
        Route::group(['prefix' => 'business-settings', 'as' => 'business-settings.', 'middleware' => ['module:settings']], function () {
            ...
            //promotional banner
            Route::get('promotional-banner-store/', function() { return redirect()->route('admin.business-settings.react-landing-page-settings', 'promotional-banner'); });
            ...
            Route::get('promotional-banner/update/{id}', function() { return redirect()->route('admin.business-settings.react-landing-page-settings', ['tab' => 'promotional-banner']); });
